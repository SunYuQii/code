'''
input file:candidate_prompt.json
output file:llmResRaw.pkl llmResRaw.json prompt2llmRes.json
'''
...
print(dataset)
model = "GLM-4-Flash"
candidate_prompt = json.load(open(f"data/{dataset}/reliability/candidate_prompt.json", "r"))
...
if os.path.exists(f"data/{dataset}/reliability/llmResRaw.pkl"):
    llmResRaw = pickle.load(open(f"data/{dataset}/reliability/llmResRaw.pkl", "rb"))

json.dump(llmResRaw, open(f"data/{dataset}/reliability/llmResRaw.json", "w"))
if os.path.exists(f"data/{dataset}/reliability/prompt2llmRes.json"):
    prompt2llmRes = json.load(open(f"data/{dataset}/reliability/prompt2llmRes.json", "r"))
if os.path.exists(f"data/{dataset}/reliability/errorIndex.json"):
    errorIndex = json.load(open(f"data/{dataset}/reliability/errorIndex.json","r"))
...
while control:
    ...
    try:
        ...
        pickle.dump(llmResRaw, open(f"data/{dataset}/reliability/llmResRaw.pkl", "wb"))
        json.dump(prompt2llmRes,open(f"data/{dataset}/reliability/prompt2llmRes.json", "w"))
        json.dump(errorIndex,open(f"data/{dataset}/reliability/errorIndex.json","w"))
